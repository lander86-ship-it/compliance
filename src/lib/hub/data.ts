...
export const STIG_GROUPS: Record<string, string[]> = {
  "Operating Systems": ["stig-rhel9", "stig-rhel8", "stig-rhel7", "stig-win2022", "stig-win2019", "stig-win2016", "stig-win2012r2", "stig-win11", "stig-win10", "stig-ubuntu2204", "stig-ubuntu2004", "stig-sles12", "stig-solaris11", "stig-aix7", "stig-macos14", "stig-macos15", "stig-oracle-linux8"],
  ...
  Databases: ["stig-postgresql", "stig-postgresql9", "stig-mssql2016", "stig-oracle19c", "stig-oracle12c", "stig-mongodb7", "stig-mongodb4"],
  "Containers & Virtualization": ["stig-k8s", "stig-docker", "stig-vsphere8-esxi", "stig-vsphere8-vcenter", "stig-vsphere8-photon", "stig-vsphere7-esxi", "stig-vsphere7-vcenter"],
  "Web & Endpoint": ["stig-apache24", "stig-tomcat9", "stig-iis10", "stig-chrome", "stig-edge", "stig-firefox", "stig-adobe-acrobat", "stig-apache24-win", "stig-iis10-site", "stig-exchange2019-mbx", "stig-office365", "stig-dotnet4", "stig-defender-av", "stig-windows-firewall"],
};
