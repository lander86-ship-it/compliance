...
export const STIG_GROUPS: Record<string, string[]> = {
  "Operating Systems": ["stig-rhel9", "stig-rhel8", "stig-rhel7", "stig-win2022", "stig-win2019", "stig-win2016", "stig-win2012r2", "stig-win11", "stig-win10", "stig-ubuntu2204", "stig-ubuntu2004", "stig-sles12", "stig-solaris11", "stig-aix7", "stig-macos14"],
  "Network & Firewall": ["stig-cisco-ios-rtr", "stig-cisco-switch-ndm", "stig-cisco-switch-l2s", "stig-cisco-asa-ndm", "stig-cisco-asa-vpn", "stig-cisco-nxos-ndm", "stig-paloalto-ndm", "stig-f5-bigip-ndm", "stig-juniper-srx-ndm", "stig-juniper-srx-alg"],
  Databases: ["stig-postgresql", "stig-postgresql9", "stig-mssql2016", "stig-oracle19c", "stig-oracle12c", "stig-mongodb7"],
  "Containers & Virtualization": ["stig-k8s", "stig-docker", "stig-vsphere8-esxi", "stig-vsphere8-vcenter", "stig-vsphere8-photon"],
  "Web & Endpoint": ["stig-apache24", "stig-tomcat9", "stig-iis10", "stig-chrome", "stig-edge", "stig-firefox", "stig-adobe-acrobat"],
};
