...
export const STIG_PRODUCTS: Record<string, { slug: string; name: string; platform: string; version: string }> = {
  ...
  "stig-ios18": { slug: "stig-ios18", name: "DISA STIG — Apple iOS/iPadOS 18", platform: "Mobile", version: "V2R3" },
  "stig-android15": { slug: "stig-android15", name: "DISA STIG — Google Android 15 (COPE)", platform: "Mobile", version: "V1R5" },
  "stig-sharepoint2013": { slug: "stig-sharepoint2013", name: "DISA STIG — Microsoft SharePoint 2013", platform: "Application", version: "V1R9" },
  "stig-cisco-nxos-rtr": { slug: "stig-cisco-nxos-rtr", name: "DISA STIG — Cisco NX-OS Switch (RTR)", platform: "Network", version: "V2R1" },
  "stig-cisco-nxos-l2s": { slug: "stig-cisco-nxos-l2s", name: "DISA STIG — Cisco NX-OS Switch (L2S)", platform: "Network", version: "V1R1" },
  "stig-juniper-ex-ndm": { slug: "stig-juniper-ex-ndm", name: "DISA STIG — Juniper EX Series Switch (NDM)", platform: "Network", version: "V2R5" },
  "stig-bind9": { slug: "stig-bind9", name: "DISA STIG — ISC BIND 9.x DNS", platform: "Network", version: "V3R3" },
  "stig-tanium7": { slug: "stig-tanium7", name: "DISA STIG — Tanium 7.x", platform: "Application", version: "V2R3" },
  "stig-splunk8": { slug: "stig-splunk8", name: "DISA STIG — Splunk Enterprise 8.x (Linux)", platform: "Application", version: "V2R3" },
  "stig-mcafee-vse": { slug: "stig-mcafee-vse", name: "DISA STIG — McAfee VirusScan (Managed Client)", platform: "Application", version: "V4R10" },
  "stig-ubuntu2404": { slug: "stig-ubuntu2404", name: "DISA STIG — Canonical Ubuntu 24.04 LTS", platform: "Linux", version: "V1R6" },
  "stig-openshift4": { slug: "stig-openshift4", name: "DISA STIG — Red Hat OpenShift Container Platform 4.x", platform: "Containers", version: "V2R6" },
  "stig-mysql8": { slug: "stig-mysql8", name: "DISA STIG — Oracle MySQL 8.0", platform: "Database", version: "V2R2" },
  "stig-mariadb10": { slug: "stig-mariadb10", name: "DISA STIG — MariaDB Enterprise 10.x", platform: "Database", version: "V2R5" },
  "stig-nutanix-aos": { slug: "stig-nutanix-aos", name: "DISA STIG — Nutanix AOS 5.20.x", platform: "Virtualization", version: "V1R1" },
  "stig-zos-racf": { slug: "stig-zos-racf", name: "DISA STIG — IBM z/OS (RACF)", platform: "Mainframe", version: "V9R9" },
  "stig-cisco-ios-ndm": { slug: "stig-cisco-ios-ndm", name: "DISA STIG — Cisco IOS XE Router (NDM)", platform: "Network", version: "V3R7" },
  "stig-aaa": { slug: "stig-aaa", name: "DISA STIG — AAA Services (SRG)", platform: "Network", version: "V2R2" },
